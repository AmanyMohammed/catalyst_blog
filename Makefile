...
#     NAME => q[Blog]
#     NO_META => q[1]
#     PREREQ_PM => { Catalyst::Plugin::Static::Simple=>q[0], namespace::autoclean=>q[0], Catalyst::View::TT=>q[0], Catalyst::Runtime=>q[5.90090], Catalyst::Plugin::StackTrace=>q[0], Test::More=>q[0.88], Catalyst::Plugin::Session::State::Cookie=>q[0], Catalyst::Plugin::Session=>q[0], Digest::MD5=>q[0], Catalyst::Plugin::Authentication=>q[0], ExtUtils::MakeMaker=>q[6.36], Catalyst::Action::RenderView=>q[0], Moose=>q[0], Config::General=>q[0], Catalyst::Plugin::ConfigLoader=>q[0], Catalyst::Plugin::Session::Store::File=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
...
PM_TO_BLIB = lib/Blog/Schema/Result/Comment.pm \
...
pure_all :: $(INST_SCRIPT)/blog_server.pl $(INST_SCRIPT)/blog_test.pl $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_cgi.pl $(INST_SCRIPT)/blog_create.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/blog_server.pl $(INST_SCRIPT)/blog_test.pl \
	  $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_cgi.pl \
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Amany Mohammed,,,</AUTHOR>' >> $(DISTNAME).ppd
...
upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::Store::File,0,Catalyst::Plugin::Session::State::Cookie,0,Test::More,0.88,Digest::MD5,0,Catalyst::Plugin::StackTrace,0,Catalyst::View::TT,0,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::Store::File,0,Catalyst::Plugin::Session::State::Cookie,0,Test::More,0.88,Digest::MD5,0,Catalyst::Plugin::StackTrace,0,Catalyst::View::TT,0,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0
...
listalldeps ::
	@$(PERL) -le "print for @ARGV" Catalyst::Plugin::Authentication Catalyst::Plugin::Session Catalyst::Plugin::Session::Store::File Catalyst::Plugin::Session::State::Cookie Test::More Digest::MD5 Catalyst::Plugin::StackTrace Catalyst::View::TT Catalyst::Runtime Catalyst::Plugin::ConfigLoader Catalyst::Plugin::Static::Simple Catalyst::Action::RenderView Moose namespace::autoclean Config::General
